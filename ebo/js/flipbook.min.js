...
viewMode: 'webgl', // "webgl", "3d", "2d", "swipe" or "simple"
*/
...
! function(O, T, y, a) {
    O.fn.flipBook = function(e) {
        ...
        var o, i = y.createElement("div").style,
            s = function() {
        ...
        this.msie = T.navigator.userAgent.indexOf("MSIE "), this.isAndroid = a, this.has3d = r, void 0 === FLIPBOOK.hasWebGl && function(e) {
            if (T.WebGLRenderingContext) {
                for (var t = y.createElement("canvas"), o = ["webgl", "experimental-webgl", "moz-webgl", "webkit-3d"], i = !1, n = 0; n < 4; n++) try {
        ...
        for (var h in l) String(e.layout) === h && (e = O.extend(!0, {}, l[h], e));
        this.options = O.extend(!0, {}, O.fn.flipBook.options, e);
        var p, c, u, g, f, b, m, k, v = this.options;
        if (v.isMobile = /iPhone|iPad|iPod|Android/i.test(navigator.userAgent), v.isMobile)
        ...
        else if (v.isIE && v.pdfBrowserViewerIfIE && v.pdfUrl) v.lightBox && !v.lightBoxOpened ? this.$elem.on("touched click", function() {
            P()
        }).css("cursor", "pointer") : P();
        else {
        ...
        createBook: function() {
            ...
            if (this.options.numPages = this.options.pages.length, this.options.numPages % 2 == 0 || this.options.singlePageMode || (this.oddPages = !0, this.options.oddPages = !0, this.options.pages.push({
                ...
                for (i = 0; i < n.options.pages.length; i++) void 0 !== n.options.pages[i].htmlContent && (n.options.hasHtmlContent = !0, n.options.pages[i].htmlContent = O(n.options.pages[i].htmlContent));
                        ...
                        switch (n.type) {
                            ...
                            case "link":
                                if (a = O("<a>").addClass("flipbook-page-item").width(n.width).height(n.height).css({
                                    ...
                                    }).attr("onmouseover", 'this.style.background="' + this.options.linkColorHover + '"').attr("onmouseout", 'this.style.background="' + this.options.linkColor + '"'), n.url) a.attr("href", n.url).attr("target", "_blank");
                                else if (n.page) {
        ...
        if (this.main = o, this.options = n, this.wrapper = e, this.active = null, n.btnThumbs.enabled) {
            ...
            for (a = 0; a < s.length; a++) {
                ...
                if (!s[a].empty) {
                    ...
                    if (this.thumbs.push(h), s[a].thumbCanvas) var c = O(s[a].thumbCanvas);
                    else {
                        if (!d) continue;
        ...
        openLightbox: function() {
            FLIPBOOK.lightboxOpened || (FLIPBOOK.lightboxOpened = !0, this.overlay.css("display", "none"), this.overlay.fadeIn("slow", function() {}), O("body").addClass("flipbook-overflow-hidden"), O("html").addClass("flipbook-overflow-hidden"))
        },
        closeLightbox: function() {
            1 == FLIPBOOK.lightboxOpened && (FLIPBOOK.lightboxOpened = !1, this.overlay.fadeOut("fast"), O("body").removeClass("flipbook-overflow-hidden"), O("html").removeClass("flipbook-overflow-hidden"), O(this.context.fullscreenElement).removeClass("flipbook-browser-fullscreen"), this.context.lightboxEnd())
        },
        resize: function() {
            var e = O(T);
            e.width(), e.height()
